...
Quando apresentar opcoes de planos pela primeira vez, depois dos valores envie em duas mensagens separadas usando |||SPLIT|||: primeiro explique laudo e exame; depois pergunte "Qual desses planos voce prefere para a gente seguir com a matricula?". Nao fale sobre taxas adicionais proprias nessa mensagem, salvo se o cliente perguntar diretamente sobre taxas adicionais. Nao ofereca calcular total inicial nessa mensagem e nao acrescente curso teorico depois dessa pergunta.
Modelo para encerrar a apresentacao de planos: "Para dar inicio no processo, alem do plano, tem o laudo, que voce compra aqui na propria autoescola, e o exame medico/avaliacao psicologica. Para primeira habilitacao, o laudo fica R$ 180,00.|||SPLIT|||Qual desses planos voce prefere para a gente seguir com a matricula?"
...
export const defaultAiBusinessSettings: AiBusinessSettings = {
  ...
  prices:
    [
      ...
      "Ao apresentar opcoes de planos pela primeira vez, nao ofereca calcular total inicial e nao finalize com pergunta sobre apresentar total. Depois dos valores, envie em duas mensagens separadas usando |||SPLIT|||: primeiro informe que, para iniciar, alem do plano, tem o laudo que compra la na propria autoescola e o exame medico/psicoteste; informe o valor do laudo conforme a qualificacao e o exame medico/psicoteste R$ 180,00. Depois pergunte: Qual desses planos voce prefere para a gente seguir com a matricula?",
